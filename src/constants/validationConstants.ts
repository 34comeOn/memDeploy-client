...
export const MAX_LENGTH_TITLE_WARNING = 'Title should be shorter 50 symbols';
// export const MAX_LENGTH_TITLE_WARNING = 'Название должно быть не длиннее 50 символов';

export const FIELD_REQUIRED_WARNING = 'Required field';
// export const FIELD_REQUIRED_WARNING = 'Обязательное поле';

export const EMAIL_INVALID_WARNING = 'Insert valid e-mail';
// export const EMAIL_INVALID_WARNING = 'Введите валидный e-mail';

export const MAX_LENGTH_ANSWER_WARNING = 'Text should be shorter 1500 symbols';
// export const MAX_LENGTH_ANSWER_WARNING = 'Текст должен быть не длиннее 1500 символов';
export const MAX_LENGTH_WARNING = 'Too many symbols';
// export const MAX_LENGTH_WARNING = 'Превышено максимальное количество символов';
export const MIN_LENGTH_NAME_WARNING = 'Not enough symbols';
...
export const PASSWORD_MIN_LENGTH_WARNING = 'The password must be at least 6 characters long';
// export const PASSWORD_MIN_LENGTH_WARNING = 'Пароль должен быть не короче 6 символов';
export const PASSWORD_MAX_LENGTH_WARNING = 'The password must be no longer than 20 characters';
// export const PASSWORD_MAX_LENGTH_WARNING = 'Пароль должен быть не длиннее 20 символов';
export const PASSWORD_MATCH_WARNING = "Passwords don't match";
// export const PASSWORD_MATCH_WARNING = 'Пароли не совпадают';
export const PASSWORD_PROHIBITED_SYMBOLS_WARNING = 'Contains invalid characters';
...
export const PASSWORD_WRONG_SYMBOLS_WARNING =
  'The password must contain at least one Latin lowercase letter, one Latin uppercase letter, one digit and one of special character @#$%^&*';
// export const PASSWORD_WRONG_SYMBOLS_WARNING =
...
'Invalid log-in or password. Try again or click on the link "Forgot password?"';
// export const LOGIN_OR_PASSWORD_WRONG_WARNING =
